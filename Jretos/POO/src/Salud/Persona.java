...
/*//El metodo get siempre genera un valor de retorno del mismo tipo de dato es atributo*/


/*// el metodo set no retorma valores y requisitos como parametro el valor del atributo*/
    ...
    public void mostrarDocuments(String tipoDocuments, Persona documento2, String nombre, String apellido, String peso, Double estatura, int edad, String sexo){
        System.out.println("El tipo de documento es "+tipoDoc);
        System.out.println("El documento es "+documento2);
        System.out.println("El nombre es "+nombre);
        System.out.println("El apellido es "+apellido);
        System.out.println("El peso es "+peso);
        System.out.println("La estatura es "+estatura);
    ...
    public double calcularPeso(double estatura, double peso){
        calcularPeso=peso/(estatura*estatura);
        if(calcularPeso<20){
            System.out.println("usted tiene sobrepeso" + calcularPeso);
        }else if(calcularPeso>20 && calcularPeso<25){
            System.out.println("usted tiene sobre peso" + calcularPeso);
